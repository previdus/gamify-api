...
public class GameStub {
	...
	public static List<ExamSection> getExamSection(){
		...
		topics.add(new Topic(3L));
		topics.add(new Topic(2L));
	    examSections.add( new ExamSection(3L, " FULL LENGTH  ", topics, new Exam(1l)) );
		...
		topics.add(new Topic(1L));
		topics.add(new Topic(4L));
		examSections.add( new ExamSection(6L, " FULL LENGTH  ", topics, new Exam(2l)) );
		topics = new ArrayList<Topic>();		
		topics.add(new Topic(1L));
		topics.add(new Topic(4L));
		...
		topics.add(new Topic(1L));
		topics.add(new Topic(4L));
		examSections.add( new ExamSection(9L, " FULL LENGTH  ", topics, new Exam(3l)) );
		return examSections;
	...
	private static void createUser(int i){
		...
		//System.out.println("user.getId():"+ usersMapForlogin.get(user.getName()).getId());
