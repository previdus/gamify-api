...
public class ApiForgotPasswordController {
	...
	@ResponseBody
	public ApiResult sendEmailToResetPassword(@RequestParam("email") String email) 
	{
	    ...
	    String tempPassword = GenericUtil.generateTemporaryPasswordBasedOnUserName(user.getName());
	    user.setPwd(tempPassword);
	    userService.saveUser(user);
	    List<String> recepients = new LinkedList<String>();
		recepients.add(email);
		String emailBody = "Your password has been reset. It has been set to "+tempPassword;
