...
public class Emailer {
      ...
      public Emailer(final String logFileName, final String logDir, final String subject, final String body,
      ...
      public void sendEmail() throws Exception {
            ...
            final javax.mail.Session session = javax.mail.Session.getDefaultInstance(props, auth);
            ...
            if (!(null == logFileName || null == logDir)) {
                  ...
                  final DataSource source = new FileDataSource(logDir + "/" + logFileName);
      ...
      private class SMTPAuthenticator extends javax.mail.Authenticator {
            ...
            public PasswordAuthentication getPasswordAuthentication() {
                  return new PasswordAuthentication(dispatcherUserName, dispatcherPassword);
            }
      }
