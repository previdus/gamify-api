    ...
    <header class="row">
      ...
      <div class="login-section">
				...
				<form:form modelAttribute="user" action="login" method="post" class="form-inline custom-form">
							<form:label id="nameLabel" class="form-control" placeholder="Username" for="name" path="name" cssErrorClass="error">Name</form:label><br/>
							<form:input path="name" /><form:errors path="name" />
						</p>
						<p>
							<form:label for="password" class="form-control" placeholder="Password" path="pwd" cssErrorClass="error">Password</form:label><br/>
							<form:input type="password" path="pwd" /><form:errors path="pwd" />
						</p>

						<p>
							<input id="login" type="submit" value="Login" class="form-control btn btn-default"/>
							<br/><br/>OR<br/><br/>
